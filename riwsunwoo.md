...
local function webhook()
	pcall(function()
		...
		local data = {
			["content"] = "",
			["username"] = "นุ้งเนยแจ้งเตือนจ้า",
			["avatar_url"] = "https://cdn.discordapp.com/attachments/1027262750608592906/1042103458754461726/56649307_323707361679355_6820938043537489920_n.jpg",
			["embeds"] = {
				{
					["author"] = {
						["name"] = "ลิงเนยฟาร์ม",
						["icon_url"] = "https://cdn.discordapp.com/attachments/1035129533650698311/1042381207113052170/b2f431a8e28e49c4514465609b4ac3dd.jpg"
					},
					["footer"] = {
					    ["text"] = "มีปัญหาติดต่อแอดมิน",
					    ["icon_url"] = "https://cdn.discordapp.com/attachments/1035129533650698311/1042383844915019797/05024467660003e1a90028a412125617.jpg",
					},
					["description"] = "👽** Username : "..game:GetService("Players").LocalPlayer.Name.."**".."\n".."📦**ชนิดการฟาร์ม = ฟาร์มเพชรปกติ**",
					["color"] = 56105,
					...
					["fields"] = {
						{
                            ...
                            ["name"] = "ลูกอมที่มีอยู่(อีเวนท์Halloween)",
                            ["value"] = tostring(game.Players.LocalPlayer._stats._resourceCandies.Value).." 🍬",
                            ["inline"] = false
                        }, {
                            ["name"] = "คำเตือนและข้อควรปฎิบัติ",
                            ["value"] = tostring("🟡ไม่อนุญาติให้เข้าเกมทุกกรณี(เพราะอาจะมีปัญหาทำให้ฟาร์มช้ากว่าเดิม)"..
                                "\n".."🟡เมื่อเริ่มฟาร์มแล้วไม่สามารถขอคืนเงินได้"..
                                "\n".."🟡สามารถเข้าเกมได้ต่อเมื่อแอดมินประกาศพักฟาร์มเท่านั้น"),
                            ["inline"] = true
                        }
			    	}
		    	}
...
function sex()
    ...
    local win = DiscordLib:Window("[👻] Anime Adventures Webhook by กนกกาย".." - "..tostring(identifyexecutor()))
    local serv = win:Server("ใช้แค่Webhookครับไอ้สัส", "http://www.roblox.com/asset/?id=6031075938")
